...
/** External site URLs for cross-site navigation tabs. */
export const SINGH_SITE_URL = "https://singhlaundry.com/new/";
export const SINGH_SERVICES_URL = "https://singhlaundry.com/new/#/services";
export const SINGH_ABOUT_URL = "https://singhlaundry.com/new/#/about";
export const SINGH_CONTACT_URL = "https://singhlaundry.com/new/#/contact";
...
export const SITE_URL = "https://bergenlaundryservice.com/";
...
/** JSON-LD: pickup & delivery laundry service — built only from data already above (no fabricated geo/ratings). */
export const LOCAL_BUSINESS_JSON_LD = {
  "@context": "https://schema.org",
  "@type": ["LocalBusiness", "LaundryOrDryCleaning"],
  name: BRAND.pickup,
  image: new URL(IMAGES.logoBergen, SITE_URL).href,
  telephone: BRAND.phoneBergen,
  url: SITE_URL,
  address: {
    "@type": "PostalAddress",
    streetAddress: LOCATIONS.newBridge.line1,
    addressLocality: LOCATIONS.newBridge.city,
    addressRegion: LOCATIONS.newBridge.state,
    postalCode: LOCATIONS.newBridge.zip,
    addressCountry: "US",
  },
  areaServed: SERVICE_ZIPS.map((z) => z.town),
  makesOffer: {
    "@type": "Offer",
    itemOffered: {
      "@type": "Service",
      name: "Laundry Pickup & Delivery (Wash & Fold)",
      areaServed: SERVICE_ZIPS.map((z) => z.town),
    },
  },
  sameAs: [
    SOCIAL.bergen.facebook,
    SOCIAL.bergen.instagram,
    SOCIAL.bergen.yelp,
    SOCIAL.bergen.google,
  ],
};
