...
export default function BergenLaundry() {
  ...
  return (
    ...
    >
      <Seo
        title="Bergen Laundry Service | Laundry Pickup & Delivery NJ"
        description="Bergen Laundry Service offers free wash & fold pickup and delivery across Bergenfield and Bergen County, NJ. Schedule your laundry pickup online today."
