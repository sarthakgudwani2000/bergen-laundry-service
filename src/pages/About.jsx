...
export default function About() {
  ...
  return (
    ...
    >
      <Seo
        title="About Bergen Laundry Service | Bergenfield, NJ"
        description="Learn how Bergen Laundry Service delivers free wash & fold pickup and delivery to homes and businesses across Bergenfield and Bergen County, NJ."
        path="/about"
        image={IMAGES.logoBergen}
      />
      <section className="page-hero-section" data-reveal-blur>
        <h1 className="h1">About Bergen Laundry Service</h1>
        <span
