...
export default function Contact() {
  ...
  return (
    ...
    >
      <Seo
        title="Contact Bergen Laundry Service | Bergenfield, NJ"
        description="Contact Bergen Laundry Service to schedule a wash & fold pickup or ask about delivery areas across Bergenfield and Bergen County, NJ."
        path="/contact"
