...
export default function Privacy() {
  ...
  return (
    ...
    >
      <Seo
        title="Privacy Policy | Bergen Laundry Service"
        description="Read Bergen Laundry Service's privacy policy on how we collect and protect customer information across our Bergenfield, NJ delivery area."
        path="/privacy"
