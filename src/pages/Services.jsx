...
export default function Services() {
  ...
  return (
    ...
    >
      <Seo
        title="Laundry Pickup & Delivery Services | Bergen Laundry"
        description="From wash & fold to specialty items, see every laundry pickup and delivery service Bergen Laundry Service offers across Bergenfield and Bergen County, NJ."
        path="/services"
      ...
      <section className="page-hero-section max-w-none" data-reveal-blur>
        ...
        <h1 className="h1 lg:whitespace-nowrap">Our Laundry Pickup &amp; Delivery Services</h1>
        <span
